...
<head>
    ...
    <title>Login Besi Maju jaya</title>
    <meta charset="utf-8">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-5">
                <div class="card shadow">
                    <div class="card-body">
                        <h1 class="h4 text-center mb-4"><b>APLIKASI KASIR</b></h1>
                        <center><img alt="logo" src="assets/img/logo.png" height="110" width="340" /></center>
                        <p>
                        <form method="POST">
...
block;"><a href="www.smknu3bws.sch.id">
                    <img src="http://www.wieistmeineip.de/ip-address/?size=468x60" border="0" width="340" height="60" alt="IP" /></a><br /></span></p>
