...
$jsArray1 = "var kode_barang = new Array();";
...
<div class="col-md-9 mb-2">
                ...
                <div class="card-body py-4">
                    <form method="POST">
                        ...
                        <div class="form-group row mb-0">
                            <label class="col-sm-4 col-form-label col-form-label-sm"><b>Shipping</b></label>
                            <div class="col-sm-8 mb-2">
                                <input type="text" class="form-control form-control-sm" name="shipping_nama" placeholder="Nama Pembeli" required>
                            </div>
                            <label class="col-sm-4 col-form-label col-form-label-sm"></label>
                            <div class="col-sm-8 mb-2">
                                <textarea class="form-control form-control-sm" name="shipping_alamat" placeholder="Alamat Pembeli" required></textarea>
                            </div>
                        </div>
                        <div class="form-group row mb-0">
                            ...
                            <div class="col-sm-8 mb-2">
                                <div class="input-group">
                                    <input type="text" name="nama_barang" class="form-control form-control-sm border-right-0" list="datalist1" onchange="changeValue(this.value)" aria-describedby="basic-addon2" required>
                                    <datalist id="datalist1">
                                        <?php if (mysqli_num_rows($barang)) { ?>
                                            <?php while ($row_brg = mysqli_fetch_array($barang)) { ?>
                                                ...
                                                $jsArray1 .= "kode_barang['" . $row_brg['nama_barang'] . "'] = {kode_barang:'" . addslashes($row_brg['id_barang']) . "'};";
                                            } ?>
                                            <?php } ?>
                                    </datalist>
                            ...
                            <div class="col-sm-8 mb-2">
                                <input type="text" class="form-control form-control-sm" name="kode_barang" id="kode_barang" readonly>
                            </div>
                 ...
                 VALUES('$idb','$nama','$harga','$qty','$total','$tgl')";
                        ...
                        $sql_update_stok = "UPDATE barang SET stok_barang = stok_barang - $qty WHERE id_barang = '$idb'";

                        try {
                            $query_update_stok = mysqli_query($conn, $sql_update_stok);
                    ...
                    while ($r = $query->fetch_assoc()) {
                        ...
                        $harga_barang = intval($r['harga_barang']);
                        $quantity = intval($r['quantity']);

                        // Mengonversi nilai menjadi bilangan pecahan
                    ...
                    <div class="card-body small pt-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 mt-5 text-center">
                                <p>* MOHON DICEK JUMLAH DAN KUALITAS BARANG. BARANG YANG SUDAH DIBELI TIDAK DAPAT DIKEMBALIKAN. *</p>
    ...
    <script type="text/javascript">
        ...
        function changeValue(nama_barang) {
            document.getElementById("harga_barang").value = harga_barang[nama_barang].harga_barang;
            document.getElementById("kode_barang").value = kode_barang[nama_barang].kode_barang;
        };

        // function changeValue(nama_barang) {
        //     document.getElementById("kode_barang").value = kode_barang[id_barang].kode_barang;
